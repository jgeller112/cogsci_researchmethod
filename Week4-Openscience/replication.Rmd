...
- Direct/close Replication 
  ...
  - New study matches the original as closely as possible
...
Replications arent strictly "successes" or "failures"
...
---
background-image: url(recipie.jpeg)
...
- A 36 question guide to replications
...
- Carefully defining the effects and methods that the researcher intends to replicate
  ...
  - Effect intended to replicate
  
    > Sans Forgetica comarped to Arial typeface enhances memory for cue-target pairs
...
- Following exactly the methods of the original study

  - Sometimes not possible
  
      - Authors do not provide enough detail
      - Dont share their materials
    
  - Contact them (for projects you will have to do this :))
...
- Making complete details about the replication available
...
- Scientific benefits: 
    ...
    - We aren’t throwing data away at the end of the semester
  
    - Small contribution leverages to big impact through collaboration
