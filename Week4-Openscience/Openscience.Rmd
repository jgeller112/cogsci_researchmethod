...
- Replication can be successful `r emo::ji("+1")`

--

- Replication be unsuccessful `r emo::ji("-1")`
---
...
> The movement to make scientific research, data, and dissemination accessible to all levels of an inquiring societ
...
knitr::include_graphics("scimethodOSF.png")
```
...
knitr::include_graphics("whycare.png")
```
...
knitr::include_graphics("osfthesis.png")
```
